...
export default function PlannerPlaceholderScreen() {
  return (
    <SafeAreaView edges={['top']} style={{ flex: 1, backgroundColor: theme.colors.bg }}>
      ...
      <View flex={1} bg={theme.colors.bg} px={24} justifyContent="center" alignItems="center">
        <Box
          ...
          alignItems="center"
        >
          <Ionicons name="calendar-clear-outline" size={54} color={theme.colors.cta} />
          <Text
            mt={18}
            fontSize={28}
          ...
          <Text
            ...
            textAlign="center"
          >
            Use this as a placeholder tab while we shape the real feature.
          </Text>
        </Box>
      </View>
    </SafeAreaView>
